  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved recipe as @recipe" do
        ...
        post :create, {:recipe => { "name" => "invalid value" }}, valid_session
        assigns(:recipe).should be_a_new(Recipe)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested recipe" do
        ...
        Recipe.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => recipe.to_param, :recipe => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the recipe as @recipe" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Recipe.any_instance.stub(:save).and_return(false)
        put :update, {:id => recipe.to_param, :recipe => { "name" => "invalid value" }}, valid_session
        assigns(:recipe).should eq(recipe)
      end
